		                ...
		                <fieldset>
		                    <div class="search-wrap">
		                        <div class="select-box">
		                            ...
		                            <a href="javascript:fn_egov_search_choice(-1, '제목')"><span id="searchConditionText"><c:out value='${(param.searchCondition == "0") ? "등록자" : "제목"}' default="제목" /></span></a>
		                            <ul class="select-box-options" id="searchSelect" style="z-index:999;display:none">
		                                <li><span><a href="javascript:fn_egov_search_choice(1, '제목');" data-role="none">제목</a></span></li>
		                                <li><span><a href="javascript:fn_egov_search_choice(0, '등록자');" data-role="none">등록자</a></span></li>
		                            </ul>
		                        </div>
